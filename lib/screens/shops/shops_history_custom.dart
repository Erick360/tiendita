...
class ShoppingHistoryCustom extends ConsumerStatefulWidget{
  ...
  static String id = "shopping_history_custom";
            ...
            children: [
              ...
              Expanded(
                child: _startDate == null
                    ? const Center(
                  child: Text(
                    "Usa el botón de arriba para buscar compras.",
                  ...
                  data: (shops) {
                    if (shops.isEmpty) {
                      return const Center(
                          child: Text(
                              "No se encontraron compras en estas fechas.",
                          ...
                          rows: shops.map((shop) {
                            return DataRow(
                              cells: [
                                ...
                                DataCell(Text(DateFormat('dd/MM/yy hh:mm a').format(shop.shopDate!))),
